...
namespace HK.Formas
{
    public partial class FrmVentas_Usuarios : Form
    {
        Usuario[] Lista;
        Administrativo data;
        ...
        {
            Lista = data.GetAllUsuarios(txtBuscar.Text);
        ...
        private void AgregarRegistro()
        {
            do
            {
                FrmVentas_UsuariosItem F = new FrmVentas_UsuariosItem();
        ...
        private void EliminarRegistro()
        {
            if (this.gridView1.IsFocusedView)
            {
                ...
                string resultado = data.EliminarUsuario(Registro,true);
                if (resultado != null)
                {
